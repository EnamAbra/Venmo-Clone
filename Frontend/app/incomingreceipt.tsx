...
export default function incomingreceipt(): JSX.Element {
  ...
  return (
    <View className="bg-white h-[120vh]">
      <SafeAreaView>
        <View>
          <TouchableOpacity
          ...
          <View className="flex-row justify-center items-center gap-x-4 mb-7">
            <TouchableOpacity
              className="bg-whie border border-primaryGreen rounded-full  py-4 items-center  px-6 font-urbanist-bold  "
              onPress={() => router.push("/incomingfinalreceipt")}
            >
